                            ...
                            <div class='absolute inset-0 w-full h-full'>
                                <SwiperSlide> 
                                    ...
                                    <div class="p-4 flex flex-col bg-white dark:bg-dark-800">
                                        ...
                                        <a href="" class="h-10 gap-2 w-full flex-center group text-gray-700 dark:text-gray-300 transition-colors duration-300 ease-in hover:bg-purple-700 hover:text-white dark:hover:bg-dark-800 border border-gray-300 dark:border-gray-600 dark:hover:border-indigo-400 rounded-2xl">
