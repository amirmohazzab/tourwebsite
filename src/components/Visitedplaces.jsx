...
const Visitedplaces = () => {
  return (
    <div class="grid grid-cols-1 p-4 mb-10 lg:grid-cols-4 lg:gap-4 sm:container">
      <div class="flex justify-between items-end px-4">
        <div className="flex flex-col gap-1 text-gray-600 font-medium lg:justify-center lg:items-center lg:gap-4 lg:w-full lg:h-full">
          <h3 class="text-base lg:text-2xl title_color "> popular places </h3>
          <h3 class="text-sm lg:text-xl title_color"> Entertainment tours </h3>
          <svg xmlns="http://www.w3.org/2000/svg" class="hidden w-24 h-24 lg:block title_color" viewBox="0 0 20 20" fill="currentColor">
